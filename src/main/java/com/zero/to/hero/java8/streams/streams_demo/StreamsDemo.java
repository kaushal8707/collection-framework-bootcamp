package com.zero.to.hero.java8.streams.streams_demo;
...
public class StreamsDemo {
    public static void main(String[] args) {
        ...
        /** count total no.of even numbers */
        ...
        System.out.println("total even number count in given list : " +count);
        //Using Java 8
        /** find count of even numbers in a given list */
